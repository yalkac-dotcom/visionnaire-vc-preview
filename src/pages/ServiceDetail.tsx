      ...
      <section className="bg-warm-gray pt-36 pb-24 md:pt-44 md:pb-32">
        <div className="container">
          ...
          <div className="flex flex-wrap gap-4 animate-reveal-up" style={{ animationDelay: "500ms" }}>
            <Link to="/#contact" className="inline-flex items-center text-[11px] uppercase tracking-[0.18em] bg-accent text-accent-foreground px-7 py-3 hover:bg-accent/85 transition-all duration-200 active:scale-[0.97]">{t.servicePage.ctaPrimary}</Link>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {service.details.map((detail, i) => (
              <ScrollReveal key={detail} delay={i * 70}>
                <div className="bg-warm-gray p-7 md:p-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
              {matchingIndustries.map((ind, i) => (
                <ScrollReveal key={ind.slug} delay={i * 80}>
                  <Link to={`/branchen/${ind.slug}`} className="block bg-warm-gray p-8 group hover:bg-warm-gray-dark transition-colors duration-300">
        ...
        <div className="container text-center">
          ...
          <ScrollReveal delay={100}>
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/#contact" className="inline-flex items-center text-[11px] uppercase tracking-[0.18em] bg-accent text-accent-foreground px-7 py-3 hover:bg-accent/85 transition-all duration-200 active:scale-[0.97]">{t.cta.projectCta}</Link>
