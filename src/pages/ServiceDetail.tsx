    ...
    <>
      <section className="bg-soft-ivory pt-36 pb-24 md:pt-44 md:pb-32">
        <div className="container">
          <Link to="/leistungen" className="inline-flex items-center gap-2 text-muted-foreground/50 hover:text-accent text-[11px] uppercase tracking-[0.18em] mb-10 transition-colors duration-200">
          ...
          <p className="text-muted-foreground text-[15px] md:text-base leading-[1.7] max-w-xl mb-12 animate-reveal-up" style={{ animationDelay: "350ms" }}>{service.desc}</p>
          <div className="flex flex-wrap gap-4 animate-reveal-up" style={{ animationDelay: "500ms" }}>
            <Link to="/#contact" className="inline-flex items-center text-[11px] uppercase tracking-[0.18em] bg-accent text-accent-foreground px-7 py-3 hover:bg-[hsl(var(--gold-deep))] transition-all duration-200 active:scale-[0.97]">{t.servicePage.ctaPrimary}</Link>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {service.details.map((detail, i) => (
              <ScrollReveal key={detail} delay={i * 70}>
                <div className="bg-cloud-neutral p-7 md:p-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
              {matchingIndustries.map((ind, i) => (
                <ScrollReveal key={ind.slug} delay={i * 80}>
                  <Link to={`/branchen/${ind.slug}`} className="block bg-cloud-neutral p-8 group hover:bg-soft-ivory transition-colors duration-300">
        ...
        <div className="container text-center">
          ...
          <ScrollReveal delay={100}>
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/#contact" className="inline-flex items-center text-[11px] uppercase tracking-[0.18em] bg-accent text-accent-foreground px-7 py-3 hover:bg-[hsl(var(--gold-deep))] transition-all duration-200 active:scale-[0.97]">{t.cta.projectCta}</Link>
              <Link to="/#contact" className="inline-flex items-center text-[11px] uppercase tracking-[0.18em] border border-foreground/15 text-foreground/60 hover:text-foreground px-7 py-3 hover:bg-foreground/3 transition-all duration-200 active:scale-[0.97]">{t.cta.contactCta}</Link>
            </div>
          </ScrollReveal>
        </div>
      </section>
