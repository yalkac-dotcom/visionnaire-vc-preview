    ...
    <>
      ...
      <section className="bg-warm-gray pt-36 pb-24 md:pt-44 md:pb-32">
        <div className="container">
          ...
          <p className="text-muted-foreground text-[15px] md:text-base leading-[1.7] max-w-xl animate-reveal-up" style={{ animationDelay: "400ms" }}>{t.insights.subline}</p>
        </div>
      </section>
              ...
              <ScrollReveal key={item.slug} delay={i * 80}>
                <article className="bg-background p-8 md:p-10 lg:p-14 h-full flex flex-col group">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-muted-foreground/35 text-[10px] tracking-[0.15em]">{item.date}</span>
                  </div>
                  ...
                  <span className="inline-flex items-center gap-2.5 text-[11px] uppercase tracking-[0.18em] text-foreground/40 group-hover:text-accent transition-colors duration-200">
                    {t.insights.readMore}
