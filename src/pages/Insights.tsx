            ...
            {t.insights.items.map((item, i) => (
              <ScrollReveal key={item.slug} delay={i * 80}>
                <article className="bg-background p-8 md:p-10 lg:p-14 h-full flex flex-col group">
                  ...
                  <span className="inline-flex items-center gap-2.5 text-[11px] uppercase tracking-[0.18em] text-foreground/35 group-hover:text-accent transition-colors duration-200">
                    {t.insights.readMore}
