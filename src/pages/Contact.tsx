    ...
    <>
      ...
      <section className="relative bg-soft-ivory pt-36 pb-24 md:pt-44 md:pb-32 overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroContact} alt="Contact Visionnaire" className="w-full h-full object-cover opacity-[0.12]" loading="eager" />
        ...
        <div className="container relative z-10">
          <p className="text-brand-blue text-[11px] uppercase tracking-[0.2em] mb-5 animate-reveal-up" style={{ animationDelay: "100ms" }}>{t.contact.label}</p>
          ...
          <p className="text-[hsl(var(--soft-charcoal))] text-[15px] md:text-base leading-[1.7] max-w-xl animate-reveal-up" style={{ animationDelay: "400ms" }}>{t.contact.text}</p>
        </div>
      </section>
          ...
          <div className="container">
            <div className="max-w-3xl">
              ...
              <ScrollReveal delay={80}>
                <p className="text-muted-foreground text-[15px] md:text-base leading-[1.8] mb-20">{t.contact.introText}</p>
              </ScrollReveal>
                  ...
                  {t.contact.subjects.map((s, i) => (
                    <ScrollReveal key={s} delay={120 + i * 70}>
                      <div className="bg-card p-7 md:p-8 h-full">
                        ...
                        <p className="text-muted-foreground text-[13px] leading-[1.7]">{t.contact.subjectDescriptions![i]}</p>
                      </div>
                    </ScrollReveal>
                  ))}
                </div>
            ...
            <div className="md:col-span-7">
              <ScrollReveal>
                <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                  <div>
                    <label className="block text-muted-foreground text-[11px] uppercase tracking-[0.18em] mb-3">{t.contact.formName}</label>
                    <input type="text" className="w-full bg-background border-b border-input py-3.5 text-foreground text-sm focus:outline-none focus:border-[hsl(var(--gold))] focus:shadow-[0_1px_0_0_hsl(var(--gold))] transition-all duration-200 placeholder:text-muted-foreground/25" />
                  </div>
                  {t.contact.formCompany && (
                    <div>
                      <label className="block text-muted-foreground text-[11px] uppercase tracking-[0.18em] mb-3">{t.contact.formCompany}</label>
                  ...
                  <div>
                    <label className="block text-muted-foreground text-[11px] uppercase tracking-[0.18em] mb-3">{t.contact.formEmail}</label>
                  ...
                  {t.contact.formPhone && (
                    <div>
                      <label className="block text-muted-foreground text-[11px] uppercase tracking-[0.18em] mb-3">Telefon</label>
                      <input type="tel" placeholder={t.contact.formPhone} className="w-full bg-background border-b border-input py-3.5 text-foreground text-sm focus:outline-none focus:border-[hsl(var(--gold))] focus:shadow-[0_1px_0_0_hsl(var(--gold))] transition-all duration-200 placeholder:text-muted-foreground/40" />
                    </div>
                  )}
                  <div>
                    <label className="block text-muted-foreground text-[11px] uppercase tracking-[0.18em] mb-3">{t.contact.formSubject}</label>
                  ...
                  <div>
                    <label className="block text-muted-foreground text-[11px] uppercase tracking-[0.18em] mb-3">{t.contact.formMessage}</label>
            ...
            <div className="md:col-span-4 md:col-start-9">
              <ScrollReveal delay={150}>
                <div className="md:pt-4">
                  <div className="mb-14">
                    <p className="text-brand-blue text-[11px] uppercase tracking-[0.2em] mb-7">{t.contact.label}</p>
                    {t.contact.address && (
                  ...
                  {t.contact.noteHeadline && (
                    <div>
                      ...
                      <p className="text-muted-foreground text-[13px] leading-[1.8]">{t.contact.note}</p>
                    </div>
                  )}
                </div>
              </ScrollReveal>
