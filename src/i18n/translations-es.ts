...
export const translationsEs: Translations = {
  nav: {
    ...
    insights: "Insights",
    contact: "Contacto",
    projectCta: "Solicitar sesión estratégica",
    contactCta: "Solicitar sesión estratégica",
  },
  hero: {
    tagline: "Consulting · Estrategia · Marca · Desarrollo Internacional",
    headline: "Estrategia que funciona. Marca que impacta. Internacional, sostenible.",
    subline: "Ayudamos a empresas ambiciosas a definir su posición estratégica, fortalecer su marca y crecer internacionalmente. No con soluciones estándar — sino con auténtico pensamiento estratégico.",
    cta: "Solicitar sesión estratégica",
    ctaSecondary: "Descubrir nuestro método",
  },
  expertise: {
  ...
  whyUs: {
    ...
    headline: "No pensamos en procesos — pensamos en resultados empresariales",
    items: [
      { title: "Orientados a resultados", desc: "No trabajamos con modelos estándar — sino con auténtico pensamiento estratégico. Cada proyecto es único." },
      { title: "Empresarios, no teóricos", desc: "Nuestros consultores son empresarios — no teóricos. Entendemos lo que está en juego." },
      { title: "Redes internacionales", desc: "Una red consolidada de socios y especialistas a nivel internacional. Con socios en el terreno." },
      { title: "Resultados medibles", desc: "Ninguna teoría sin implementación. Medimos nuestro éxito por el éxito de su negocio." },
    ],
  },
  businessUnits: {
  ...
  contact: {
    label: "Contacto",
    headline: "Solicitar una consultoría estratégica gratuita",
    text: "30 minutos, sin compromiso, confidencial. Si desea discutir un proyecto o solicitar consultoría estratégica, esperamos con interés su mensaje.",
    ...
    formSubject: "Asunto",
    formMessage: "Mensaje breve (máx. 500 caracteres)",
    formSend: "Solicitar sesión estratégica",
    subjects: ["Solicitar sesión estratégica", "Solicitar consultoría", "Consulta general"],
  ...
  industryPage: { backToOverview: "Todos los sectores", consultingFields: "Campos de consultoría relevantes", challengesLabel: "Desafíos principales", projectsLabel: "Proyectos seleccionados", ctaPrimary: "Solicitar sesión estratégica", ctaSecondary: "Descubrir nuestro método", matchingServices: "Servicios relacionados" },
  servicePage: { backToOverview: "Todos los servicios", whatWeSupport: "En qué apoyamos", typicalSituations: "Situaciones típicas", relevantIndustries: "Sectores relevantes", ctaPrimary: "Solicitar sesión estratégica", ctaSecondary: "Descubrir nuestro método" },
  cta: { projectCta: "Solicitar sesión estratégica", consultationCta: "Descubrir nuestro método", contactCta: "Solicitar sesión estratégica" },
  datenschutz: {
  ...
  seo: { defaultTitle: "Visionnaire Consulting – Consultoría estratégica para empresas en crecimiento", defaultDescription: "Consultoría estratégica para empresas ambiciosas. Ayudamos en realineamiento, reposicionamiento de marca y crecimiento internacional. Con auténtico pensamiento estratégico en lugar de soluciones estándar.", titleSuffix: "Visionnaire Consulting" },
};
