    ...
    <section id="industries" className="py-28 md:py-36 bg-background">
      <div className="container">
        ...
        <ScrollReveal delay={80}>
          <h2 className="text-foreground text-[1.5rem] md:text-[2rem] lg:text-[2.5rem] font-light leading-[1.2] tracking-[-0.01em] max-w-2xl mb-6">
            {t.industries.headline}
          </h2>
        </ScrollReveal>
        <ScrollReveal delay={120}>
          <p className="text-muted-foreground text-[15px] leading-[1.7] max-w-xl mb-16">
