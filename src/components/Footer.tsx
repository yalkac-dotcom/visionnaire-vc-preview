    ...
    <footer className="bg-footer py-16 md:py-20">
      <div className="container">
        ...
        <div className="mb-12 pb-12 border-b border-white/8">
          <p className="text-white/30 text-[11px] tracking-[0.15em] uppercase">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <p className="text-white/75 tracking-[0.3em] text-[12px] font-light mb-2">
              {t.footer.brand}<span className="text-white/30 ml-1.5 tracking-normal text-[11px]">{t.footer.consulting}</span>
            </p>
